<x-app-layout title="Plany Treningowe">
            ...
            @foreach($workoutPlans as $plan)
                <tr>
                    ...
                    <td class="py-2 px-4 border-b">
                        <a href="{{ route('workout-plans.show', $plan->id) }}" class="bg-green-500 text-white px-4 py-2 rounded hover:bg-green-700">Szczegóły</a>
                    </td>
                </tr>
            @endforeach
            </tbody>
