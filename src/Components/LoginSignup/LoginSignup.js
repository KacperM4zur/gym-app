...
//                         <div className="form-questions">Lost password? <span>Click Here!</span></div>)}
//                     {action === "Sign Up" ? <div></div> : (
//                         <div className="form-questions"> You do not have an account? <span onClick={() => setAction("Sign Up")} >Create account!</span></div>)}
//                     {action === "Login" ? <div></div> : (
//                         <div className="form-questions">If you have account <span onClick={() => setAction("Login")} >Login here!</span></div>)}
