<x-app-layout title="Grupy ćwiczeń">
    <div class="flex justify-end mb-4">
        <a href="{{ route('exercises-group.index') }}" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-700">
            Powrót
        </a>
    </div>
    <div id="form-container" class="flex flex-col justify-start items-center text-white py-12 px-4 sm:px-6 lg:px-8">
        <div class="w-full max-w-4xl bg-dark shadow-lg rounded-lg p-8 mt-8">
            <h3 class="text-3xl font-bold mb-8 text-left">{{ $group->getKey() ? 'Edytuj grupę ćwiczeń' : 'Stwórz grupę ćwiczeń' }}</h3>
